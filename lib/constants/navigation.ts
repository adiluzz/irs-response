...
export const navigation: NavCategory[] = [
  {
    ...
    items: [
      { id: 'cp14', label: 'CP14', href: '/notice/cp14', status: 'available' },
      { id: 'cp501', label: 'CP501', href: '/notice/cp501', status: 'available' },
      { id: 'cp503', label: 'CP503', href: '/notice/cp503', status: 'available' },
      { id: 'cp504', label: 'CP504', href: '/notice/cp504', status: 'available' },
    ],
  },
  {
    id: 'underreporter',
    ...
    items: [
      { id: 'cp2000', label: 'CP2000', href: '/notice/cp2000', status: 'available' },
