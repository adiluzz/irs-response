// app/notice/letter1058/page.tsx
'use client'
...
export default function Letter1058Page() {
  ...
  const handleDownload = useCallback(() => {
    ...
    link.href = url
    link.download = `letter1058-response-${formData.taxYear || 'taxyear'}-${Date.now()}.txt`
    ...
    <SplitView>
      ...
      >
        ...
        <FormSection
          ...
          description="Select the reason and your position for this Letter 1058 response."
        >
          <FormRow columns={2}>
        ...
        <FormSection
          ...
          description="Enter the specific information from your Letter 1058 notice."
        >
          <FormRow columns={2}>
