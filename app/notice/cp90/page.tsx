  ...
  return (
    <AuthGuard>
      <FormPanel
        ...
        noticeBadge="CP90 — Final Notice of Intent to Levy"
      >

        <FormSection
          title="Response Context"
          description="Select the reason and your position for this CP90 response."
        >
          <FormRow columns={2}>
        ...
        <FormSection
          ...
          description="Enter the specific information from your CP90 notice."
        >
          <FormRow columns={2}>
        ...
        {hasGenerated && documentId && !isGenerating && (
          <Box sx={{ mt: 3 }}>
            <DocumentActionButtons documentId={documentId} noticeType="CP90" />
          </Box>
        )}
      </FormPanel>
    </AuthGuard>
